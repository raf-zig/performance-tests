...
from performance_tests.contracts.services.gateway.cards.rpc_issue_virtual_card_pb2 import IssueVirtualCardRequest, IssueVirtualCardResponse
from performance_tests.contracts.services.gateway.cards.rpc_issue_physical_card_pb2 import IssuePhysicalCardRequest, IssuePhysicalCardResponse
from performance_tests.contracts.services.gateway.cards.cards_gateway_service_pb2_grpc import CardsGatewayServiceStub
...
class CardsGatewayGRPCClient(GRPCClient):
    ...
    def issue_virtual_card_api(self, request: IssueVirtualCardRequest) -> IssueVirtualCardResponse:
        ...
        :param request: gRPC-запрос с данными Virtual Card.
        :return: Ответ от сервиса с данными Virtual Card.
        """
    ...
    def issue_physical_card_api(self, request: IssuePhysicalCardRequest) -> IssuePhysicalCardResponse:
        ...
        :param request: gRPC-запрос с данными Physical Card.
        :return: Ответ от сервиса с данными Physical Card.
        """
    ...
    def issue_virtual_card(self, user_id: str, account_id: str) -> IssueVirtualCardResponse:
        """
        Получение данных virtual card.

        :param user_id: Идентификатор пользователя.
        :param account_id: Идентификатор аккаунта.
        :return: Ответ с информацией о Virtual Card.
        """
    ...
    def issue_physical_card(self, user_id: str, account_id: str) -> IssuePhysicalCardResponse:
        """
        Получение данных physical card.

        :param user_id: Идентификатор пользователя.
        :param account_id: Идентификатор аккаунта.
        :return: Ответ с информацией о Physical Card.
        """
