...
from performance_tests.contracts.services.gateway.documents.documents_gateway_service_pb2_grpc import DocumentsGatewayServiceStub
from performance_tests.contracts.services.gateway.documents.rpc_get_contract_document_pb2 import (
    GetContractDocumentRequest,
    GetContractDocumentResponse
)
from performance_tests.contracts.services.gateway.documents.rpc_get_tariff_document_pb2 import (
