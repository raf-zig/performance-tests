...
import builtins
import performance_tests.contracts.services.documents.receipts.receipt_pb2
...
class GetOperationReceiptResponse(google.protobuf.message.Message):
    ...
    @property
    def receipt(self) -> performance_tests.contracts.services.documents.receipts.receipt_pb2.Receipt: ...
    def __init__(
        self,
        *,
        receipt: performance_tests.contracts.services.documents.receipts.receipt_pb2.Receipt | None = ...,
    ) -> None: ...
