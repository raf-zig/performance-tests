from performance_tests.clients.http.gateway.accounts.client import build_accounts_gateway_http_client
from performance_tests.clients.http.gateway.operations.client import build_operations_gateway_http_client
...
# пополняем счет
operations_response = operations_gateway_client.make_top_up_operation(
    card_id=open_debit_card_account_response['account']['cards'][0]['id'],
    account_id=open_debit_card_account_response['account']['id']
)
print('Make top up operation response:', operations_response)
