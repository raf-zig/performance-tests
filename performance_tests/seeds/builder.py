from performance_tests.clients.grpc.gateway.accounts.client import build_accounts_gateway_grpc_client, AccountsGatewayGRPCClient
from performance_tests.clients.grpc.gateway.cards.client import build_cards_gateway_grpc_client, CardsGatewayGRPCClient
from performance_tests.clients.grpc.gateway.operations.client import build_operations_gateway_grpc_client, OperationsGatewayGRPCClient
from performance_tests.clients.grpc.gateway.users.client import build_users_gateway_grpc_client, UsersGatewayGRPCClient
from performance_tests.clients.http.gateway.accounts.client import build_accounts_gateway_http_client, AccountsGatewayHTTPClient
from performance_tests.clients.http.gateway.cards.client import build_cards_gateway_http_client, CardsGatewayHTTPClient
from performance_tests.clients.http.gateway.operations.client import build_operations_gateway_http_client, OperationsGatewayHTTPClient
from performance_tests.clients.http.gateway.users.client import build_users_gateway_http_client, UsersGatewayHTTPClient
from performance_tests.seeds.schema.plan import (
    SeedsPlan,
    SeedUsersPlan,
    SeedAccountsPlan,
)
from performance_tests.seeds.schema.result import (
    SeedsResult,
    SeedUserResult,
    SeedCardResult,
    SeedAccountResult,
...
class SeedsBuilder:
    ...
    def build_virtual_card_result(self, user_id: str, account_id: str) -> SeedCardResult:
        """
        Выпускает virtual карту для заданного пользователя и счёта.
    ...
    def build_cash_withdrawal_operation_result(self, card_id: str, account_id: str) -> SeedOperationResult:
        """
        Выполняет операцию cash_withdrawal.
